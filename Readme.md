...
## چالش های آینده
### outBox Pattern
این پترن باید حتما در تمام پروژه های میکروسرویسی به کار برده شود چون احتمال دارد قبل از پالیش پیام دیتا عملیاتی انجام شود ولی وقتی به عمل publish رسید کرش اتفاق بیافتد یعنی عملیات کاربر با نوفقیت اتفاق افتاده اما قبل publish  سرور کرش کند این یک خطای مهم هست که با الگو نام برده شد میتوان آن را کنترل کرد. 
